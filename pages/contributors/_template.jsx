...
module.exports = React.createClass({
  ...
  render () {
    const childPages = config.contributorPages.map((p) => {
    ...
    const contributorOptions = childPages.map((child) =>
      <option
    ...
    const contributorPages = childPages.map((child) => {
